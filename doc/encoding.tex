...
that are understood in any valid contexts.
...
% \bibitem{nordstrom} Nordstrom, Bengt and Petersson, Kent and Smith, Jan M. \textit{Programming in Martin-L\"{o}f's Type Theory: An Introduction}
...
% \bibitem{backhouse}  R.C.Backhouse,P.F.Hoogendijk \textit{Final  dialgebras : from categories to allegories} 1999
